...
void viewdetails(void)
{
	...
	printf("-----------------------------------------------------------------------------");
	printf("\n1001\tREHMAN BABA Express\tKARACHI to RAWALPINDI\tRs.5000\t\t9am");
	printf("\n1002\tREHMAN BABA Express\tRAWALPINDI To KARACHI\tRs.5000\t\t12pm");
	printf("\n1003\tGREEN LINE Express\t\tKARACHI To QUETTA\t\tRs.4500\t\t8am");
	printf("\n1004\tGREEN LINE Express\t\tQUETTA To KARACHI\t\tRs.4500\t\t11am");
	printf("\n1005\tSIR SYED Express\tKARACHI To PESHAWAR\tRs.4000\t\t7am");
	printf("\n1006\tSIR SYED Express\tPESHAWAR To KARACHI\tRs.4000\t\t9.30am");
    printf("\n1007\tHAZARA Express\tKARACHI To MULTAN\tRs.3500\t\t1pm");	
    printf("\n1008\tHAZARA Express\tMULTAN To KARACHI\tRs.3500\t\t4pm");
    printf("\n1009\tKARACHI Express\t\tKARACHI To LAHORE\t\tRs.6000\t\t3.35pm");
    printf("\n1009\tKARACHI Express\t\tLAHORE To KARACHI\t\tRs.6000\t\t4.15pm");
...
void specifictrain(int train_num)
{
	...
	if (train_num==1001)
	{
		printf("\nTrain:\t\t\tREHMAN BABA Express");
		printf("\nDestination:\t\tKARACHI to RAWALPINDI");
		printf("\nDeparture:\t\t9am ");
	}
	if (train_num==1002)
	{
		printf("\nTrain:\t\t\tREHMAN BABA Express");
		printf("\nDestination:\t\tRAWALPINDI to KARACHI");
		printf("\nDeparture:\t\t12pm");
	}
	if (train_num==1003)
	{
		printf("\nTrain:\t\t\tGREEN LINE Express");
		printf("\nDestination:\t\tKARACHI to QUETTA");
		printf("\nDeparture:\t\t8am");
	}
	if (train_num==1004)
	{
		printf("\nTrain:\t\t\tGREEN LINE Express");
		printf("\nDestination:\t\tQUETTA to KARACHI");
		printf("\nDeparture:\t\t11am ");
	}
	if (train_num==1005)
	{
		printf("\nTrain:\t\t\tSIR SYED Express");
